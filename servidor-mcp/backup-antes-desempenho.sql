...
INSERT INTO "tipos_negocio" ("tipo","rotulo") VALUES('mercado','Supermercado');
INSERT INTO "tipos_negocio" ("tipo","rotulo") VALUES('farmacia','Farmácia');
...
CREATE INDEX idx_estab_tipo ON estabelecimentos(tipo, ativo);
CREATE INDEX idx_estab_dono ON estabelecimentos(dono_user_id);
CREATE INDEX idx_encartes_vigentes
  ON encartes(estabelecimento_id, ativo, vigencia_fim);
CREATE INDEX idx_itens_encarte_encarte ON itens_encarte(encarte_id);
CREATE INDEX idx_itens_encarte_produto  ON itens_encarte(produto);
CREATE INDEX idx_itens_encarte_ean      ON itens_encarte(ean);
