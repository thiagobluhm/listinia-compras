...
Plugin de Cowork para gestão da despensa de casa: captura notas fiscais
...
## Arquitetura: um orquestrador e cinco especialistas
...
Nada para configurar: ao instalar o plugin, a Claude abre a tela de login do
